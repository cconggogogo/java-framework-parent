package com.ccong.framework.common.time;

import com.ccong.framework.common.lang.Validate;
...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
     ...
     * 获取以毫秒为单位的Unix时间戳
     *
     * @return 毫秒为单位的Unix时间戳
     */
    public static long getUnixTimestampOfMillis() {
     ...
     * @return 秒为单位的Unix时间戳
     */
    public static long getUnixTimestampOfSeconds() {
     ...
     * @return 毫秒为单位的Unix时间戳
     */
    public static long convertUnixTimestampToMillis(long timestamp) {
     ...
     * @return 秒为单位的Unix时间戳
     */
    public static long convertUnixTimestampToSeconds(long timestamp) {
        return timestamp > 999_999_999_9L ? timestamp / 1000L : timestamp;
    }
